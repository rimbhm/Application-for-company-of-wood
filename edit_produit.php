...
include 'connexion.php';
    ...
    $id = intval($_GET['id']);
	$q = @mysql_query("SELECT * FROM produit WHERE id=".$id);
			...
			<div class="main-container-inner">
				...
				<div class="main-content">
					...
					<div class="page-content">
						<center><img src="image/image47.jpg"></center>
						<div class="row">
							<div class="col-xs-12">
								<!-- PAGE CONTENT BEGINS -->
								...
								<div class="form-group">
									...
									<div class="col-sm-9">
										<input name="prix" type="text"  class="col-xs-10 col-sm-5" value="<?php echo $prix; ?>">
									</div>

									<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> Description </label>
									<div class="col-sm-9">
										<textarea id="desc" cols="40" rows="5"><?php echo  $desc; ?></textarea>
									</div>

								    <label class="col-sm-3 control-label no-padding-right" for="form-field-1"> Date Entrée </label>
									<div class="col-sm-9">
										<input name="date" type="date" class="col-xs-10 col-sm-5" value="<?php echo $date; ?>">
									</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
										    ...
										    <?php echo '<img src="upload/'.$logo.'" width="100"/>'; ?>
	...
	$('#formulaire').submit(function() {
		...
		*/
		...
		$.ajax({
			type: 'post',
			url: 'edit.php',
			data: 'nom='+nom+'&prix='+prix+'&desc='+desc +'&date='+date+'&id='+id,
